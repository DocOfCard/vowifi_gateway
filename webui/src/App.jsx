  ...
  return (
    <div style={{ display: 'flex', height: '100%' }}>
      <aside style={{ width: 220, background: 'var(--sidebar)', borderRight: '1px solid var(--border)', padding: 16, display: 'flex', flexDirection: 'column', gap: 6 }}>
        ...
        <button onClick={async()=>{try{await api.authLogout()}catch{} setCsrf(null); location.reload()}} style={{margin:'0 8px 8px',padding:'7px',borderRadius:8,border:'1px solid var(--border)',background:'transparent',color:'var(--text-dim)',cursor:'pointer'}}>Sign out</button>
      </aside>
